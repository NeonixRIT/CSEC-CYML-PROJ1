...
def find_important_features(autoencoder: Autoencoder, full_dataset: NetFlowDataSet):
    ...
    {13: ('Flow Bytes/s', 0.003927684882000904),
    75: ('Idle Max', 0.00286572429286025),
    73: ('Idle Mean', 0.0027598217402555747),
    17: ('Flow IAT Max', 0.0026498937786527677),
    22: ('Fwd IAT Max', 0.002398798269496183),
    76: ('Idle Min', 0.00208358678901277),
    0:  ('Flow Duration', 0.001603344715476851),
    19: ('Fwd IAT Total', 0.0014476983615168137),
    41: ('Packet Length Variance', 0.001090961768568377),
    27: ('Bwd IAT Max', 0.0008813637814455433),
    21: ('Fwd IAT Std', 0.0008760383625485701),
    24: ('Bwd IAT Total', 0.0007779802235745592),
    16: ('Flow IAT Std', 0.0007390469818346901),
    15: ('Flow IAT Mean', 0.0005638601414830191),
    14: ('Flow Packets/s', 0.0004904000361420913),
    26: ('Bwd IAT Std', 0.0003571593242668314),
    20: ('Fwd IAT Mean', 0.00035411398675933015),
    74: ('Idle Std', 0.00033513264315843116),
    18: ('Flow IAT Min', 0.0002816759206325514),
    25: ('Bwd IAT Mean', 0.00010983653010043781),
    23: ('Fwd IAT Min', 6.229329846973997e-05),
    35: ('Fwd Packets/s', 5.496199264598545e-05),
    28: ('Bwd IAT Min', 3.085926982748788e-05),
    12: ('Bwd Packet Length Std', 2.7228821636526845e-05),
    36: ('Bwd Packets/s', 1.652043101785239e-05),
    9:  ('Bwd Packet Length Max', 1.5434392480528913e-05),
    65: ('Init_Win_bytes_forward', 1.3028373359702528e-05),
    71: ('Active Max', 9.772153134690598e-06),
    69: ('Active Mean', 7.83136420068331e-06),
    72: ('Active Min', 7.594657290610485e-06),
    10: ('Bwd Packet Length Min', 7.3010287451324984e-06),
    11: ('Bwd Packet Length Mean', 6.932135875103995e-06),
    53: ('Avg Bwd Segment Size', 6.891992597957142e-06),
    66: ('Init_Win_bytes_backward', 4.881356289843097e-06),
    45: ('PSH Flag Count', 4.112052920390852e-06),
    46: ('ACK Flag Count', 9.614905138732865e-07),
    50: ('Down/Up Ratio', 7.995404303073883e-07),
    64: ('Subflow Bwd Bytes', 7.892813300713897e-07),
    4:  ('Total Length of Bwd Packets', 7.873622962506488e-07),
    38: ('Max Packet Length', 6.242389645194635e-07),
    37: ('Min Packet Length', 5.057172529632226e-07),
    40: ('Packet Length Std', 4.336634447099641e-07),
    68: ('min_seg_size_forward', 4.2869214667007327e-07),
    39: ('Packet Length Mean', 4.087924025952816e-07),
    51: ('Average Packet Size', 3.898003342328593e-07),
    33: ('Fwd Header Length', 3.4619915822986513e-07),
    54: ('Fwd Header Length', 3.45518856192939e-07),
    42: ('FIN Flag Count', 3.4434378903824836e-07),
    1:  ('Total Fwd Packets', 3.189106791978702e-07),
    61: ('Subflow Fwd Packets', 3.143450157949701e-07),
    3:  ('Total Length of Fwd Packets', 3.061068127863109e-07),
    62: ('Subflow Fwd Bytes', 3.0290357244666666e-07),
    2:  ('Total Backward Packets', 3.0157025321386755e-07),
    63: ('Subflow Bwd Packets', 3.001605364261195e-07),
    7:  ('Fwd Packet Length Mean', 2.9740112950094044e-07),
    52: ('Avg Fwd Segment Size', 2.9278089641593397e-07),
    6:  ('Fwd Packet Length Min', 2.898941602325067e-07),
    67: ('act_data_pkt_fwd', 2.8799331630580127e-07),
    5:  ('Fwd Packet Length Max', 2.8624708647839725e-07),
    70: ('Active Std', 2.53492544288747e-07),
    34: ('Bwd Header Length', 2.0309016690589488e-07),
    44: ('RST Flag Count', 1.527660060673952e-07),
    49: ('ECE Flag Count', 1.5175282896962017e-07),
    43: ('SYN Flag Count', 8.311872079502791e-08),
    29: ('Fwd PSH Flags', 8.177630661521107e-08),
    30: ('Bwd PSH Flags', -1.8189894035458565e-12),
    31: ('Fwd URG Flags', -1.8189894035458565e-12),
    32: ('Bwd URG Flags', -1.8189894035458565e-12),
    48: ('CWE Flag Count', -1.8189894035458565e-12),
    55: ('Fwd Avg Bytes/Bulk', -1.8189894035458565e-12),
    56: ('Fwd Avg Packets/Bulk', -1.8189894035458565e-12),
    57: ('Fwd Avg Bulk Rate', -1.8189894035458565e-12),
    58: ('Bwd Avg Bytes/Bulk', -1.8189894035458565e-12),
    59: ('Bwd Avg Packets/Bulk', -1.8189894035458565e-12),
    60: ('Bwd Avg Bulk Rate', -1.8189894035458565e-12),
    47: ('URG Flag Count', -2.7996065909974277e-08),
    8:  ('Fwd Packet Length Std', -4.727553459815681e-08)}
...
def main():
    ...
    # test_classifier(autoencoder, classifier, test_dataset)
